...
public class JsonHelper {
     ...
     * @return
     */
    public static <T> Collection<T> toList(Object object, Class<T> objectClass) throws Exception {
        String json = mapper.writeValueAsString(object);
        List<T> sList = mapper.readValue(json, List.class);
        return sList;
    }
    ...
    public static String object2json(Object obj) {
        ...
        if (obj == null) {
            ...
            json.append(collection((List<?>) obj));
        } else if (obj instanceof Map) {
            json.append(map2json((Map<?, ?>) obj));
        } else if (obj instanceof Set) {
            json.append(collection((Set<?>) obj));
        } else {
    ...
    public static String collection(Collection<?> list) {
        StringBuilder json = new StringBuilder();
        json.append("[");
